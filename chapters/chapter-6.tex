...
\begin{mdframed}[backgroundcolor=ApricotWhite, frametitle={CHART 15: The Benefits of Assured Survival}]
    \begin{itemize}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{./chart-16.png}
    \label{fig:icbm-traj}
\end{figure}
